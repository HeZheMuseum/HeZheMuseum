<template>
  <div class="costumes d-flex flex-column align-center">
    <div class="container">
      ...
      <section class="content-section">
        <h2>服饰装饰与图案</h2>
        <p>赫哲人的传统衣裤、鞋帽、被褥等绣有各种图案。衣领、衣襟、袖口、下摆、围裙、裤腿、帽耳、鞋面、烟荷包上绣有云纹、几何纹和各种花朵、蝴蝶等。</p>
        ...
        <div class="special-techniques">
          <h3>特殊工艺</h3>
          <p>赫哲人还把鱼、兽皮剪成各种图样，只用颜料或天然植物颜料染成各种颜色缝上。尤其是妇女穿的衣服，托领、襟边、袖头、围裙上多绣或镶嵌各种云纹、花朵。过去还用鲜花颜色染于鱼兽皮衣服上，十分美观。</p>
          <p>把各种小布块剪成三角形、方形、菱形，拼成各种几何图案，做成被、褥。</p>
        </div>
      </section>
      ...
      <section class="content-section">
        <h2>现代传承与保护</h2>
        <p>随着时代的发展，赫哲族传统服饰面临着传承的挑战。现在，通过非物质文化遗产保护、民族文化传承人培养等方式，这一独特的服饰文化得到了有效的保护和传承。</p>
        
        <div class="protection-measures">
          <div class="measure-card">
            <h3>文化传承</h3>
            <p>培养年轻一代的传承人，传授传统制作技艺</p>
          </div>
          <div class="measure-card">
            <h3>技艺保护</h3>
            <p>记录和保存传统制作工艺，建立技艺档案</p>
          </div>
          <div class="measure-card">
            <h3>创新发展</h3>
            <p>在保持传统特色的基础上，融入现代设计元素</p>
          </div>
          <div class="measure-card">
            <h3>文化推广</h3>
            <p>通过展览、表演等形式推广赫哲族服饰文化</p>
          </div>
        </div>
      </section>
    </div>
