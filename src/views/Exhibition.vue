          ...
          <div class="artwork-item">
           ...
           <div class="artwork-item">
             ...
             <div class="artwork-info">
               ...
               <div class="artwork-detail">
                 <p class="detail-text">"溯渔成裳"系列鱼皮衣，深度挖掘赫哲族渔猎文化。以棕色调为主旋律，呼应民族传统服饰底色，承载岁月沉淀的厚重感。鱼皮面料经特殊鞣制，保留天然纹理，呈现独特银色光泽，复刻赫哲族"鱼皮部落"印记，是对鱼皮制作技艺这一非遗的时尚传承。设计融合现代时装廓形，风衣、裙装等形制适配当代审美，同时以鱼皮拼接、刺绣展现民族图腾，让古老渔猎符号重焕生机，借服饰传递赫哲族与自然共生的智慧，实现传统与现代的对话，让民族文化在时尚语境中鲜活延续。</p>
               </div>
             </div>
           </div>
           ...
           <div class="artwork-item">
             ...
             <div class="artwork-info">
               ...
               <div class="artwork-detail">
                 <p class="detail-text">"鳞衣·赫彩"系列服装设计灵感，源于对非遗民族文化与自然意象的深度挖掘。以民族服饰基因库为底蕴，提取传统纹样中象征守护与力量的图腾元素，如神兽、云纹等，融入"鳞"的形态联想，借鳞片的秩序感与独特肌理，诠释文化传承的坚韧脉络。秉持"非遗新生"理念，将赫哲族文化与现代时尚语言融合。以"赫彩"展现色彩层次，运用鱼鳞为主调，棕褐、米白交织，搭配局部金色装饰，既呼应民族服饰的质朴厚重，又借金属光泽提亮，营造传统与现代碰撞的视觉张力，传递文化自信与时尚先锋态度。</p>
               </div>
             </div>
           </div>
